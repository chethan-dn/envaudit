...
This document describes what EnvAnalyser detects today. It reflects the current implementation, not a roadmap.
...
- Explicit runtime override via `envanalyser scan --env <path>`
